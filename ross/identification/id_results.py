...
__all__ = ["ID_Results","ID_FrequencyResponseResults", "ID_TimeResponseResults"]


class ID_Results(ABC):
    """Results class.
...
class ID_FrequencyResponseResults(ID_Results):
...
class ID_TimeResponseResults(ID_Results):
